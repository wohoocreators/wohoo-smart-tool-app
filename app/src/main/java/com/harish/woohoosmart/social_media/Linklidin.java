...
public class Linklidin extends AppCompatActivity {
private WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_linklidin);
        webView=findViewById(R.id.linkweb);
        ...
        webView.loadUrl("https://www.linkedin.com/signup");
